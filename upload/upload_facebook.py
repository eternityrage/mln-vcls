"""
Facebook Reels Upload - DokTok Lens
...
def upload_to_facebook(video_path, description, title="Milana Vocals"):
    print("\n" + "=" * 60)
    print("FACEBOOK UPLOAD STARTING - MILENA VOCALS")
    print("=" * 60)
...
def upload_to_facebook_story(video_path):
    print("\n" + "=" * 60)
    print("FACEBOOK STORY UPLOAD STARTING - DOKTOK LENS")
    print("=" * 60)
