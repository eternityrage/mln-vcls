"""
Upload videos to VK (VKontakte) - Milana Vocals
"""
import os
import vk_api
...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        message = description if description else "Milana Vocals - Beautiful Songs & Melodies!\n\n#milana #milanavocals #singing #vocalist"
        ...
        video = upload.video(
            ...
            name=title or 'Milana Vocals Video',
